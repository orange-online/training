...
public final class ReflectionUtils {
	...
	/**
	 * 从src拷贝field值到dest中,无视private/protected修饰符,不经过getter函数.
	 */
	public static void copyFields(final Object src, final Object dest, final String[] fields) throws OgnlException {

		// TODO,应该考虑fields为空的情况(此种情况则负责src中的所有属性)
...
//			logger.error("in copyFields, value is " + value);
////			BeanUtils.copyProperty(dest, field, value);
////			BeanUtils.setProperty(dest, field, value);
//			PropertyUtils.setProperty(dest, field, value);
			// 本来准备用setFieldValue方法的,不过没设置成功,所以用BeanUtils来替代
